...
import (
	...
	. "github.com/pkliczewski/provider-operators/apiserver-vmware/pkg/client/clientset_generated/clientset/typed/vms/v1alpha1"
...
var _ = Describe("ExternalVm controller", func() {
	var instance ExternalVm
	var expectedKey string
	var client ExternalVmInterface
	...
	BeforeEach(func() {
		...
		expectedKey = "externalvm-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.VmsV1alpha1().ExternalVms("externalvm-controller-test-handler")
