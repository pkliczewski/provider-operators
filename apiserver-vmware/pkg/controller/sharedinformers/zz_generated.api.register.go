...
import (
	...
	"github.com/pkliczewski/provider-operators/apiserver-vmware/pkg/client/informers_generated/externalversions"
...
func (si *SharedInformers) startInformers(shutdown <-chan struct{}) {
	go si.Factory.Vms().V1alpha1().ExternalVms().Informer().Run(shutdown)
}
